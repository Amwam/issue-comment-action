...
const getIssueComments_1 = require("./getIssueComments");
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const comments = yield getIssueComments_1.getIssueComments(token);
            const hasKeyword = checkKeyword_1.checkKeyword(keywords, Object.assign(Object.assign({}, content), { comments }));
            if (!hasKeyword) {
